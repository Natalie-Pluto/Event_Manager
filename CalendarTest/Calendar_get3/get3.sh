...
python3 /Users/natalielu/Desktop/INFO1112/Asm2/cald/calendar.py GET DATE 20-100-1986 07-10-2005 2>> error.csv
rm db.csv
python3 /Users/natalielu/Desktop/INFO1112/Asm2/cald/calendar.py GET DATE 19-11-1960 "Happy Birthday" 2>> error.csv


num=$(ps | grep 'Calendar_get3' | grep -v 'grep' | cut -c 1-6)
