...
# Get commands - date action option - multiple args
python3 /Users/natalielu/Desktop/INFO1112/Asm2/cald/calendar.py GET INTERVAL 01-01-1900 01-01-2021 >> get4.csv

num=$(ps | grep 'Calendar_get' | grep -v 'grep' | cut -c 1-6)
